...
(function() {
  var BlobConverter, ChatRoom, EMOTICON_MAP, FirebaseInteractor, VideoRecorder,
  ...
  ChatRoom = (function() {
    ...
    ChatRoom.prototype.hasEmotions = function(msg) {
      var emotion, face, faces, _i, _len;
    ...
    ChatRoom.prototype.displayMessage = function(data) {
      var quiz_video, source, video, _ref;
  ...
  VideoRecorder = (function() {
    ...
    VideoRecorder.prototype.mediaSuccessCallback = function(stream) {
      ...
      second_counter_update = setInterval((function(_this) {
        return function() {
